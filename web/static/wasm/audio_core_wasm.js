...
function findWasmBinary() {
  ...
  if (Module['locateFile']) {
    return locateFile('audio_core_wasm.wasm');
  }

  // Use bundler-friendly `new URL(..., import.meta.url)` pattern; works in browsers too.
  return new URL('audio_core_wasm.wasm', import.meta.url).href;
...
var _audio_core_normalized_rms = Module['_audio_core_normalized_rms'] = makeInvalidEarlyAccess('_audio_core_normalized_rms');
var _audio_core_normalized_peak = Module['_audio_core_normalized_peak'] = makeInvalidEarlyAccess('_audio_core_normalized_peak');
var _audio_core_is_speech = Module['_audio_core_is_speech'] = makeInvalidEarlyAccess('_audio_core_is_speech');
var _audio_core_is_speech_webrtc = Module['_audio_core_is_speech_webrtc'] = makeInvalidEarlyAccess('_audio_core_is_speech_webrtc');
var _audio_core_trim_silence = Module['_audio_core_trim_silence'] = makeInvalidEarlyAccess('_audio_core_trim_silence');
var _audio_core_resample_linear = Module['_audio_core_resample_linear'] = makeInvalidEarlyAccess('_audio_core_resample_linear');
...
function assignWasmExports(wasmExports) {
  ...
  assert(typeof wasmExports['audio_core_normalized_rms'] != 'undefined', 'missing Wasm export: audio_core_normalized_rms');
  assert(typeof wasmExports['audio_core_normalized_peak'] != 'undefined', 'missing Wasm export: audio_core_normalized_peak');
  assert(typeof wasmExports['audio_core_is_speech'] != 'undefined', 'missing Wasm export: audio_core_is_speech');
  assert(typeof wasmExports['audio_core_is_speech_webrtc'] != 'undefined', 'missing Wasm export: audio_core_is_speech_webrtc');
  assert(typeof wasmExports['audio_core_trim_silence'] != 'undefined', 'missing Wasm export: audio_core_trim_silence');
  assert(typeof wasmExports['audio_core_resample_linear'] != 'undefined', 'missing Wasm export: audio_core_resample_linear');
  ...
  _audio_core_normalized_rms = Module['_audio_core_normalized_rms'] = createExportWrapper('audio_core_normalized_rms', 2);
  _audio_core_normalized_peak = Module['_audio_core_normalized_peak'] = createExportWrapper('audio_core_normalized_peak', 2);
  _audio_core_is_speech = Module['_audio_core_is_speech'] = createExportWrapper('audio_core_is_speech', 3);
  _audio_core_is_speech_webrtc = Module['_audio_core_is_speech_webrtc'] = createExportWrapper('audio_core_is_speech_webrtc', 5);
  _audio_core_trim_silence = Module['_audio_core_trim_silence'] = createExportWrapper('audio_core_trim_silence', 8);
  _audio_core_resample_linear = Module['_audio_core_resample_linear'] = createExportWrapper('audio_core_resample_linear', 6);
