# Install a no-password Scheduled Task that starts Django as the currently
# logged-in Windows user. Run from an elevated PowerShell.
...
$TaskName = "IELTS Studio Django (User)"
$UserId = [System.Security.Principal.WindowsIdentity]::GetCurrent().Name
$ScriptPath = Join-Path $ProjectRoot "scripts\windows\run-django-user.ps1"
