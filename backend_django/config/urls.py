...
urlpatterns = [
    ...
    path("spelling-drill.js", frontend_asset, {"asset_path": "spelling-drill.js"}, name="frontend-spelling-drill-js"),
    ...
    path("api/attempts/<str:attempt_id>/examiner-tts/warmup", speaking_views.attempt_examiner_tts_warmup_view, name="attempt-examiner-tts-warmup"),
    path("api/attempts/<str:attempt_id>/turns/<str:turn_id>/model-tts", speaking_views.turn_model_tts_view, name="turn-model-tts"),
    ...
    path("api/corpus/saved-status", speaking_views.corpus_saved_status_view, name="corpus-saved-status"),
    ...
    path("api/p2-bank-corpus/batch", speaking_views.p2_bank_corpus_batch_view, name="p2-bank-corpus-batch"),
    path("api/p3-bank-corpus/batch", speaking_views.p3_bank_corpus_batch_view, name="p3-bank-corpus-batch"),
    path("api/p2-bank-corpus/<path:question_id>", speaking_views.p2_bank_corpus_detail_view, name="p2-bank-corpus-detail"),
    path("api/p3-bank-corpus/item/<path:followup_id>", speaking_views.p3_bank_corpus_item_view, name="p3-bank-corpus-item"),
    path("api/p3-bank-corpus/<path:p2_question_id>", speaking_views.p3_bank_corpus_view, name="p3-bank-corpus"),
    ...
    path("api/takeaway-review-state/<str:kind>", speaking_views.takeaway_review_state_view, name="takeaway-review-state"),
    path("api/expression-replacements/<str:kind>", speaking_views.expression_replacements_view, name="expression-replacements"),
    path("api/expression-replacements/<str:kind>/<path:item_id>", speaking_views.expression_replacement_detail_view, name="expression-replacement-detail"),
    ...
    path("api/writing/custom-prompts", writing_views.custom_prompts, name="writing-custom-prompts"),
    path("api/writing/custom-prompts/create", writing_views.custom_prompt_create, name="writing-custom-prompt-create"),
    path("api/writing/custom-prompts/<str:prompt_id>", writing_views.custom_prompt_detail, name="writing-custom-prompt-detail"),
    path("api/writing/entries", writing_views.entries, name="writing-entries"),
    path("api/writing/entry-for-prompt", writing_views.entry_for_prompt_view, name="writing-entry-for-prompt"),
    path("api/writing/entries/<str:entry_id>", writing_views.entry_detail, name="writing-entry-detail"),
    path("api/writing/entries/<str:entry_id>/report", writing_views.entry_report, name="writing-entry-report"),
